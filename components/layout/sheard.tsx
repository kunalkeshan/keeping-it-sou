...
type ListItemProps = React.ComponentProps<"a"> & LinkItemType;
...
export function LinkItem({
  ...
  return (
    <a
      className={cn(
        "group hover:bg-accent dark:hover:bg-accent/50 flex h-14 w-full items-center gap-x-3 border-b px-3",
        className
      )}
      href={href}
      {...props}
    >
      {Icon && (
        <Icon
          className={cn(
            "fill-primary/10 text-primary group-hover:fill-primary/25 size-4"
          )}
        />
      )}
