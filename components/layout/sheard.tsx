...
export function LinkItem({
	...
	return (
		<a
			className={cn(
				"group flex h-14 w-full items-center gap-x-3 border-b px-3 hover:bg-accent dark:hover:bg-accent/50",
				className
			)}
			href={href}
			{...props}
		>
			{Icon && (
				<Icon
					className={cn(
						"size-4 fill-primary/10 text-primary group-hover:fill-primary/25"
					)}
				/>
			)}
