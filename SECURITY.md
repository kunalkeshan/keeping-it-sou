...
- Sanity CMS infrastructure and the embedded Studio at `/cms`
- Third-party services integrated into the site (Google Analytics, Microsoft Clarity)
- Streaming platforms linked to from releases (Spotify, Apple Music, YouTube Music, etc.)
...
1. **GitHub Security Advisories (preferred)** — go to the [Security tab](https://github.com/kunalkeshan/keeping-it-sou/security/advisories/new) of this repository and submit a private advisory.
2. **GitHub profile** — reach out via [https://github.com/kunalkeshan](https://github.com/kunalkeshan).
